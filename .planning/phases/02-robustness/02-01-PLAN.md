...
Note: We are NOT adding a 'transcribing-audio' ProcessingStatus. Server actions cannot stream status updates mid-execution, so we handle this in the UI by showing an upfront message that processing may take longer (see Plan 02-02).
  </action>
  <verify>
  ...
  <done>
    ...
    - Types ready for use in transcription module
  </done>
</task>
